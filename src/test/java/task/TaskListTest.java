...
public class TaskListTest {
    ...
    private List<String> getWeeklyStrings(String module, int taskCount) {
        return Collections.singletonList("Task List for " + module.toUpperCase(Locale.ROOT) + ":"
                ...
                + "1.[ ] Read Book C by: 23 Oct 2021 04:00 PM" + System.lineSeparator()
                + "2.[ ] Read Book B by: 23 Oct 2021 04:00 PM" + System.lineSeparator()
                + "3.[ ] Read Book A by: 23 Oct 2021 12:00 PM" + System.lineSeparator());
    }

    @Test
    void showAllWeekly_success() {
        TaskList a = new TaskList();
        a.addTask("cs1010", "Read Book C /by 23/10/2021 1600");
        a.addTask("cs1010", "Read Book B /by 23/10/2021 1600");
        a.addTask("cs1010", "Read Book A /by 23/10/2021 1200");
